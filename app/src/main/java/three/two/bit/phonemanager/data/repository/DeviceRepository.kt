...
interface DeviceRepository {
    ...
    suspend fun getGroupMembers(): Result<List<DeviceInfo>>
...
class DeviceRepositoryImpl @Inject constructor(
    ...
    /**
     * Get all devices in the current group
     *
     * @return Result with list of devices or error
     */
    override suspend fun getGroupMembers(): Result<List<DeviceInfo>> {
        ...
        return deviceApiService.getGroupMembers(groupId)
    }
